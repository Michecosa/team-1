      ...
      html: `
        ...
        <table align="center" width="100%" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td style="padding:40px;">
                    <p style="font-size:16px;color:#333333;margin-top:0;line-height:1.6;">
                        ...
                        we have received your order on <strong>${order.date}</strong>.
                    </p>

                    <table width="100%" cellpadding="12" cellspacing="0"
                        style="border-collapse:collapse;margin:25px 0;border-radius:8px;overflow:hidden;">
                        <tr style="background:#f5f7fa;font-weight:bold;color:#111111;">
                        ...
                        <tr style="background:#f9fafc;">
                            <td colspan="2" style="font-weight:bold;padding:8px 12px;">Total</td>
                            <td align="right" style="font-weight:bold;padding:8px 12px;">€${order.total_amount}</td>
                        </tr>
                        ${order.free_shipping ? `
                        <tr style="background:#ffffff;">
                            <td colspan="3" style="font-weight:bold;padding:8px 12px;color:#111111;">Free Shipping</td>
                        </tr>` : ""}
                    </table>

                    <h4 style="margin-bottom:8px;color:#333333;">Shipping Address</h4>
                    <p style="font-size:14px;color:#555555;line-height:1.6;margin-top:0;">
                    ...
                    <div style="text-align:center;margin:35px 0;">
                        <a href="http://localhost:5173/"
                            style="background:#111111;color:#e3be85;text-decoration:none;
                                  padding:14px 28px;border-radius:1px;font-size:14px;font-weight:bold;display:inline-block;">
                            Track your order status and manage shipments
                        </a>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td style="background:#f5f7fa;padding:20px 30px;text-align:center;">
                    <p style="margin:0;font-size:12px;color:#888888;line-height:1.5;">
                        This message was automatically generated by the system.<br>
                        © <strong>DUALIA</strong> – All rights reserved
                    </p>
                </td>
            </tr>
